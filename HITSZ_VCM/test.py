...
import math
from tools.visualize import visualize_ranked_results
...
parser.add_argument('--resume', '-r', default='VCM_drop_0.2_2_4_lr_0.1_seed_0t2v_map_best.t', type=str,help='resume from checkpoint')
...
def test1():
    ...
    # q_imgs = data_set.query
    # q_imgs_4584 = []
    # for i in q_imgs:
    #     q_imgs_4584.append(i[0][00])
    # g_imgs = data_set.gallery
    # g_imgs_5099 = []
    # for j in g_imgs:
    #     g_imgs_5099.append(j[0][00])
    # query = [q_imgs_4584, q_pids]
    # gall = [g_imgs_5099, g_pids]
    # _datasets = [query, gall]
    # visualize_ranked_results(distmat, _datasets)
...
def test2():
    ...
    # q_imgs = data_set.query_1
    # q_imgs_4584 = []
    # for i in q_imgs:
    #     q_imgs_4584.append(i[0][00])
    # g_imgs = data_set.gallery_1
    # g_imgs_5099 = []
    # for j in g_imgs:
    #     g_imgs_5099.append(j[0][00])
    # query = [q_imgs_4584, q_pids]
