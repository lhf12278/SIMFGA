...
class embed_net(nn.Module):
    def __init__(self, args, class_num, drop=0.2, no_local='on', gm_pool='on', arch='resnet50'):
        ...
        self.avgpool = nn.AdaptiveAvgPool2d((1, 1))
        self.PCB = FFM(class_num=class_num)
        ...
        self.SpatialFeature = SpatialFeature(args, num_stripes=3, embed_dim=pool_dim,  seq_len=args.seq_lenth, class_num=class_num)
...
if __name__ == '__main__':
    net = embed_net(n_class=1074, no_local='on', gm_pool='on')
    print(net)
